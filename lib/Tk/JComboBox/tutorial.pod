...
=head2 About JComboBox

* L<JComboBox Reference|Tk::JComboBox>, L<Changes|Tk::JComboBox::Changes> L<Example Code|Tk::JComboBox::Examples>

* L<CWidget|Tk::CWidget> - I<JComboBox extends this>

* L<Boolean Utils|Tk::CWidget::BooleanUtils> - I<JComboBox uses this for booleans>

=head2 Alternative Widgets

Standard Distro: L<BrowseEntry|Tk::BrowseEntry>, L<Optionmenu|Tk::Optionmenu>

CPAN: JBrowseEntry, ComboEntry (part of Tk-DKW), MenuEntry (part of Tk-GBARR)

=head1 VERSION

This document was last updated 5 Feb 2005, and covers the 1.03 release
of JComboBox.
